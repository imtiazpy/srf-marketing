...
const OurTeam: React.FC<IOurTeam> = ({ className, ...sectionProps }) => {
  return (
    <section className={`${styles.bgImage} px-20 py-10 flex flex-col gap-6 `}>
