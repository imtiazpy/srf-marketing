...
const AboutUs: React.FC<IAboutUs> = ({ className, ...sectionProps }) => {
  return (
    <section id='about' className='h-auto md:h-[90vh] px-2 sm:px-5 md:px-10 py-10 md:py-20 grid grid-cols-1 md:grid-cols-2 bg-slate-100 object-cover gap-10'>
      <div>
        <Image priority style={{width: 'auto', height: 'auto'}} src="/about-us-transparent.png" alt="group photo" width='600' height='600' />
      </div>
      <div className='flex flex-col gap-4'>
        <p className='green'>Our Achievements</p>
        <h1 className='text-3xl font-semibold text-black'>Stuff about us</h1>
        <p className='text-gray-700'>We are the best digital agency specialized in social media marketing. Our team is comprised of experts in the field who use innovative strategies to help businesses succeed in the ever-evolving world of social media. Trust us to enhance your online presence and drive real results for your brand.</p>
